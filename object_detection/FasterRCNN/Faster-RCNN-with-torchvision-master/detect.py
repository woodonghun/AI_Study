...
def get_args():
    ...
    parser.add_argument('--model_path', type=str, default='./result/model_4.pth', help='model path')
    parser.add_argument('--image_path', type=str, default='./imgs/10.jpg', help='image path')
    parser.add_argument('--model', default='fasterrcnn_resnet50_fpn', help='model')
    parser.add_argument('--dataset', default='coco', help='model')
    parser.add_argument('--score', type=float, default=0.85, help='objectness score threshold')
